...
namespace FitMoldova.DataAccesLayer.Migrations
{
    ...
    [Migration("20260604120000_AddPasswordResetCodes")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FitMoldova.Domain.Entities.Post.PollEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FitMoldova.Domain.Entities.Post.PollOptionEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FitMoldova.Domain.Entities.Post.PostEntity", b =>
                {
                    ...
                    b.Property<int?>("AttachedChallengeId")
                        .HasColumnType("integer");

                    b.Property<int?>("AttachedChallengeProgress")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("AttachedChallengeId");
            ...
            modelBuilder.Entity("FitMoldova.Domain.Entities.User.PasswordResetCodeEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FitMoldova.Domain.Entities.Post.PollEntity", b =>
                {
                    b.HasOne("FitMoldova.Domain.Entities.Post.PostEntity", "Post")
                        .WithOne("Poll")
                        .HasForeignKey("FitMoldova.Domain.Entities.Post.PollEntity", "PostId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("FitMoldova.Domain.Entities.Post.PollOptionEntity", b =>
                {
                    b.HasOne("FitMoldova.Domain.Entities.Post.PollEntity", "Poll")
                        .WithMany("Options")
            ...
            modelBuilder.Entity("FitMoldova.Domain.Entities.Post.PostEntity", b =>
                {
                    b.HasOne("FitMoldova.Domain.Entities.Challenge.ChallengeEntity", "AttachedChallenge")
                        .WithMany()
                        .HasForeignKey("AttachedChallengeId")
                    ...
                    b.Navigation("AttachedChallenge");
