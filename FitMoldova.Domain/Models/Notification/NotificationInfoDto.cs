namespace FitMoldova.Domain.Models.Notification
{
     public class NotificationInfoDto
     {
          ...
          /// Prezent doar pentru tipul "club_post" — frontend-ul face redirect la /forum?postId=X
          public int?   PostId         { get; set; }

          /// Prezent doar pentru tipul "club_post" — poate fi afișat în UI ("Club: Runners Chișinău")
