                        ...
                        {notifOpen && (
                            <div className="nav-dropdown" style={{ width: 320, maxHeight: 400, overflowY: 'auto', right: 0 }}>
                                <div className="nav-dropdown-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                    ...
                                    {unreadCount > 0 && (
                                        <button
                                            style={{ background: 'none', border: 'none', color: '#60a5fa', fontSize: '0.75rem', cursor: 'pointer', fontWeight: 700 }}
                                            onClick={() => {
                                ...
                                <span style={{ fontSize: '0.82rem', color: '#f1f5f9', fontWeight: n.isRead ? 400 : 700 }}>
                                  {n.content}
                                </span>
                                            <span style={{ fontSize: '0.72rem', color: '#7dd3fc' }}>{n.fromUserName} · {new Date(n.createdAt).toLocaleDateString('ro-RO')}</span>
                                        </div>
                                    ))
                                )}
                                <div className="nav-dropdown-divider" />
