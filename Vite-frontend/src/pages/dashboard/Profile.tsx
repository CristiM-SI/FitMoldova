                        ...
                        <Card elevation={0} sx={{ borderRadius: 3, border: '1px solid #e8edf3', height: '100%' }}>
                            <CardContent sx={{ p: 3 }}>
                                ...
                                <Box sx={{ mb: 2 }}>
                                    ...
                                    {isEditing ? (
                                        <TextField fullWidth multiline rows={4} size="small" name="bio" value={editData.bio}
                                                   onChange={handleChange} placeholder="Spune ceva despre tine..."
                                                   sx={{ mt: 0.5, '& .MuiOutlinedInput-root': { borderRadius: 2 } }} />
                                    ) : (
                                        <Typography variant="body2" sx={{ mt: 0.25, lineHeight: 1.7 }}>
                                            {user?.bio || <Box component="span" sx={{ color: '#94a3b8', fontStyle: 'italic' }}>Nicio descriere adaugata.</Box>}
                                        </Typography>
                                    )}
                                </Box>
                            ...
                            {[
                                ...
                                <Box key={s.label} sx={{ flex: '1 1 160px', minWidth: 0 }}>
                                    <Box sx={{ p: 2.5, borderRadius: 2, bgcolor: s.bg, border: `1px solid ${s.color}20`, textAlign: 'center' }}>
                                        <Typography fontSize="2rem" sx={{ mb: 0.5 }}>{s.emoji}</Typography>
